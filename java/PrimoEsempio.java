...
public class PrimoEsempio {
	 ...
	 *
	 * @param x un intero che passo al mio metodo (input).
	 * @param y un altro intero che passo al mio metodo (input).
	 * @return la somma dei valori ottenuti in input.
	 */
	static int SempliceMetodo(int x, int y) {
		int risultato;
		risultato = x + y;
		return risultato; // Restituisco il valore della variabile risultato
	}
}
